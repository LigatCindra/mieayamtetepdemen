...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            <!-- @if (Route::has('login'))
            ...
            {{-- <div class="p-6 lg:p-8" style="display:flex; flex-orientation:row; flex-wrap: wrap;">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 normflex mx-6" >
                    <div class="container">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td style="display:flex">
                                        <form method="POST" action="{{ route('kategori.edit', $category->id_kategori) }}">
                                            @csrf
                                            @method('PUT')
                                            <input type="text" name="nama_kategori" class="form-control" required>
                                            <button type="submit" class="btn btn-primary">Edit Category</button>
                                        </form>
                                        <form style="margin-left:5px;" method="POST" action="{{ route('kategori.destroy', $category->id_kategori) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="delete" class="btn btn-primary">Delete Category</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 normflex">
                    <div class="container">
                        <div class="lcontainer">
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex">
                                        ...
                                        <form style="margin-left:5px;" method="POST" action="{{ route('makanan.destroy', $row->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="delete" class="btn btn-primary">Delete Makanan</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
