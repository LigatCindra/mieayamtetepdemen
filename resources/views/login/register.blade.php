            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="original_admin_password" class="form-label">Original Admin Password</label>
                            <input type="password" name="original_admin_password" class="form-control" id="password"
                                required>
                        </div>
                        @error('original_admin_password')
